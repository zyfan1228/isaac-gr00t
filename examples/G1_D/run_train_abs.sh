...
CUDA_VISIBLE_DEVICES=7 python gr00t/experiment/launch_finetune.py \
    ...
    --dataset-path /mnt/data/fanzhuoyao/data_library/gr00t_lerobot_dataset_v2.1/20260518_place_cup_merge_all_joints_abs \
    --embodiment-tag G1_D_ARMS_JOINTS \
    --modality-config-path examples/G1_D/g1_d_abs_joints_config.py \
    --vlm-model-path /mnt/data/share/model/Cosmos-Reason2-2B \
    --num-gpus 1 \
    --output-dir ./outputs_g1d_place_cup/abs-joints_40-chunk \
    --save-total-limit 15 \
    --save-steps 5000 \
    --max-steps 100000 \
    --save-only-model \
    --use-wandb \
    --wandb-project n1d7_g1d_sft-place_cup \
