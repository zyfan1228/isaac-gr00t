...
- Convert a local lerobot v3.0 dataset to v2.1:

    python convert_v3_to_v2.py --dataset-path /path/to/mydataset

  The original v3.0 dataset remains unchanged, and the converted v2.1 dataset
  will be saved to /path/to/mydataset_v2.1.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Local path to the v3.0 LeRobot dataset to convert.",
    )
    parser.add_argument(
        "--output-path",
        type=str,
        default=None,
        help="Custom path to save the converted v2.1 dataset. "
        "Defaults to '<dataset_path_parent>/<dataset_folder_name>_v2.1'.",
    )
